...
from omnivoice.cli.demo_cz import build_demo
...
def _gen_core(
    ...
    if not text or not text.strip():
        return None, "Prosím, zadejte text pro syntézu."
    ...
    if mode == "clone":
        if not ref_audio:
            return None, "Prosím, nahrajte referenční audio soubor."
    ...
    try:
        ...
        return None, f"Chyba: {type(e).__name__}: {e}"

    waveform = (audio[0] * 32767).astype(np.int16)
    return (sampling_rate, waveform), "Hotovo."
